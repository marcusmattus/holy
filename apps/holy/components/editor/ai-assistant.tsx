...
const INITIAL_MESSAGES: Message[] = [
  {
    role: 'assistant',
    content: "✦ Holy AI ready. Describe what you want to build and I'll generate the code for you.",
  },
]
...
export function AIAssistant({ projectId }: { projectId: string }) {
  ...
  const send = () => {
    ...
    setMessages((prev) => [
      ...prev,
      userMsg,
      { role: 'assistant', content: `Generating component for: "${input}"\n\nCode generated and applied to editor. ✦` },
    ])
    setInput('')
  }

  return (
    <div className="w-80 flex-shrink-0 flex flex-col border-l border-border bg-card" data-project={projectId}>
