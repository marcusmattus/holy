...
export function AppCard({ id, name, description, author, price, rating, downloads, category }: AppCardProps) {
  return (
    <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-3 hover:border-[#7C3AED]/50 transition-colors">
      <div className="flex items-start justify-between">
        ...
        <span className="text-xs text-muted-foreground border border-border px-2 py-0.5 rounded-full">{category}</span>
      </div>
      <div>
