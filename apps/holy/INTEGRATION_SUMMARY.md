...
/* Animations */
@keyframes pulse-gold { /* Pulsing indicator */ }
@keyframes shimmer-effect { /* Shimmer sweep */ }
@keyframes streaming { /* Loading dots */ }

/* Status Indicators */
.status-pulse { /* Animated gold dot */ }
.streaming-dot { /* AI loading */ }
```
